...
What do you think?  
As the prior standard deviation decreases, the model starts generalizing well. Uncertainty on the parameters, $\beta$ induce Uncertainty on the mean trend,$\mu$.
...
The final tuned models have selected same features with coefficients that are close to each other
