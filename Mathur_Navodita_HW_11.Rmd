...
```{r, solution_07f}
set.seed(1234)
xgb_tune <- train(outcome ~ ., data = df_caret,
                     method = "xgbTree",
                     tuneGrid = xgb_grid,
                     metric = my_metric,
                     trControl = my_ctrl,
...
What do you think?  
Each model have different techniques for getting trained and tuned depending on the type, Each can excel in different scenarios depending on the nature of the data and the task at hand.
For this data, tuned elastic model fits the data the best, although the accuracies are close to each other.