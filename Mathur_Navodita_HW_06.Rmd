...
\implies \mu = 11
$$
On substituting the value of $\mu$ in $\mu + 2 \sigma = 12$, we get
$$
11+2\sigma = 12\\
\implies 2\sigma = 1\\
\implies \sigma = 0.5
...
my_logpost <- function(unknowns, my_info)
{
  ...
  log_lik <-  dnorm(my_info$xobs, lik_mu, lik_sigma, log=TRUE)%>%sum
...
param_grid %>% 
  ...
  geom_point(data = tibble::tibble(xbar = x_bar, xsd = sdx),
...
$$
$$
\implies \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \log \left( \prod_{n=1}^{N} \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right)\right) + \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right)
$$
Taking log inside, product changes to sum,
$$
 \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \sum_{n=1}^{N} \left( \log \left(   \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) \right) + \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right)        
$$
Let us simplify the two expressions separately,

$\mathrm{normal} \left( x_n \mid \mu, \sigma \right)$ is given by ${\frac{1}{\sqrt{2\pi \sigma^{2}}}e^{{-1/2\sigma^{2}}{\left(x-\mu\right)}^2}}$

$$
\log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) = \log \left( \frac{1}{\sqrt{2\pi \sigma^{2}}}e^{-\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2} \right)
$$
$$
\implies \log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) = \log \left( \frac{1}{\sqrt{2\pi \sigma^{2}}}\right) + \log \left(e^{-\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2} \right)
$$
$$
\implies \log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) = \log \left( \frac{1}{\sqrt{2\pi \sigma^{2}}}\right) - {\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2}
$$
$$
\implies \log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) = \log \left( 1 \right) - \log \left(\sqrt{2\pi \sigma^{2}}\right) - {\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2}
$$
$$
\implies \log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) =  - \log \left(\sqrt{2\pi \sigma^{2}}\right) - {\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2}
$$
$\log \left(\sqrt{2\pi \sigma^{2}}\right)$ can be computed as
$$
\log \left(\sqrt{2\pi \sigma^{2}}\right) = \frac{1}{2}\log \left( 2\pi\sigma^2\right)
$$
$$
\implies \log \left(\sqrt{2\pi \sigma^{2}}\right) = \frac{1}{2}\left( \log \left( 2\pi \right) + \log \left(\sigma^2\right) \right)
$$
$$
\implies \log \left(\sqrt{2\pi \sigma^{2}}\right) = \frac{1}{2}\left( \log \left( 2\pi \right) + 2\log \sigma \right)
$$
On substituting the value of $\log \left(\sqrt{2\pi \sigma^{2}}\right)$ in $\log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right)$ we get,
$$
\log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right) =  - \left( \frac{1}{2}\left( \log \left( 2\pi \right) + 2\log \sigma \right)\right) - {\frac{1}{2\sigma^{2}}{\left(x_n-\mu\right)}^2}
$$
Next,
    $\mathrm{normal} \left( \mu \mid \mu_{0}, \tau_{0} \right)$ is given by $\frac{1}{\sqrt{2\pi \tau_{0}^{2}}}\exp^{{-\frac{1}{2\tau_{0}^{2}}}{\left(\mu-\mu_{0}\right)}^2}$

$$
\log \left( \mathrm{normal} \left( \mu \mid \mu_{0}, \tau_{0} \right) \right) = \log \left( \frac{1}{\sqrt{2\pi \tau_{0}^{2}}}\exp^{-\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2} \right)
$$
$$
\implies \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right) = \log \left( \frac{1}{\sqrt{2\pi \tau_{0}^{2}}}\right) + \log \left(e^{-\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2} \right)
$$
$$
\implies \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right) = \log \left( \frac{1}{\sqrt{2\pi \tau_{0}^{2}}}\right) - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
$$
\implies \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right) = \log \left( 1 \right) - \log \left(\sqrt{2\pi \tau_{0}^{2}}\right) - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
$$
\implies \log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right)) =  - \log \left(\sqrt{2\pi \tau_{0}^{2}}\right) - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
$\log \left(\sqrt{2\pi \tau_{0}^{2}}\right)$ can be dropped as it does not contain $\mu$

$$
\log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right) \propto - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
On substituting the values of $\log \left( \mathrm{normal} \left( x_n \mid \mu, \sigma \right) \right)$ and $\log \left( \mathrm{normal}\left( \mu \mid \mu_0, \tau_0\right) \right)$ in $\log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right)$ we get,
$$
\log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \sum_{n=1}^{N} \left(  - \left(\frac{1}{2}\left( \log \left( 2\pi \right) + 2\log \sigma \right)\right) - \frac{{\left(x_n-\mu\right)}^2}{2\sigma^{2}} \right)  - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
$$
\implies \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \sum_{n=1}^{N} \left(-\frac{1}{2} \log \left( 2\pi\right) \right) + \sum_{n=1}^{N} \left( - \frac{1}{2} \log \sigma \right) - \sum_{n=1}^{N} \frac{ {{\left(x_n-\mu\right)}^2}}{2\sigma^{2}} - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
Dropping the terms that does not contain $\mu$, we get
$$
\log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  - \frac{1}{2\sigma^{2}}\sum_{n=1}^{N} \left( x_n-\mu \right) ^2 - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}
$$
 
Taking derivative of $\log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right)$, we get,
$$
\frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \frac{d}{d\mu} \left( - \frac{1}{2\sigma^{2}}\sum_{n=1}^{N} \left( x_n -\mu\right) ^2 - {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}\right)
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto - \frac{d}{d\mu} \left( \frac{1}{2\sigma^{2}} \sum_{n=1}^{N} \left(x_n-\mu\right)^2 \right) - \frac{d}{d\mu} \left( {\frac{1}{2\tau_{0}^{2}}{\left(\mu-\mu_{0}\right)}^2}\right)
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto - \frac{1}{2\sigma^{2}}\frac{d}{d\mu} \left( \sum_{n=1}^{N} \left(x_n-\mu\right)^2 \right) - \frac{1}{2\tau_{0}^{2}}\frac{d}{d\mu} \left (\mu-\mu_{0}\right) ^2
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto - \frac{1}{2\sigma^{2}}\sum_{n=1}^{N} \left( \frac{d}{d\mu}  {{\left(x_n-\mu\right)}^2} \right) - \frac{1}{2\tau_{0}^{2}}\frac{d}{d\mu} \left (\mu-\mu_{0}\right) ^2
$$
Solving $\frac{d}{d\mu}  {{\left(x-\mu\right)}^2}$

Let $x-\mu$ be u, then
$$
\frac{d}{d\mu}  {{\left(x_n-\mu\right)}^2} = \frac{d u^{2}}{du}.\frac{du}{d\mu}
$$
So, $\frac{d}{du} u^2 = 2u$ and 
$$
\frac{du}{d\mu} = \frac{d}{d\mu} \left( x_n-\mu \right) = -1
$$
On substituting the values in $\frac{d}{d\mu}  {{\left(x_n-\mu\right)}^2}$we get,
$$
\frac{d}{d\mu}  {{\left(x_n-\mu\right)}^2} = 2 \left( x_n - \mu\right) \left(-1 \right)
$$
Similarly,
Solving $\frac{d}{d\mu}  {{\left(\mu-\mu_{0}\right)}^2}$

Let $\mu-\mu_{0}$ be u, then
$$
\frac{d}{d\mu}  {{\left(\mu-\mu_{0}\right)}^2} = \frac{d u^{2}}{du}.\frac{du}{d\mu}
$$
So, $\frac{d}{du} u^2 = 2u$ and 
$$
\frac{du}{d\mu} = \frac{d}{d\mu} \left( \mu-\mu_{0} \right) = 1
$$
On substituting the value in $\frac{d}{d\mu}  {{\left(\mu-\mu_{0}\right)}^2}$, we get
$$
\frac{d}{d\mu}  {{\left(\mu-\mu_{0}\right)}^2} = 2 \left( \mu - \mu_{0}\right) \left(1 \right) \\
\implies \frac{d}{d\mu}  {{\left(\mu-\mu_{0}\right)}^2} = 2 \left( \mu - \mu_{0}\right)
$$
On substituting the values of $\frac{d}{d\mu}  {{\left(x-\mu\right)}^2}$ and $\frac{d}{d\mu}  {\left(\mu-\mu_{0}\right)}^2$ in $\frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right)$ we get,
$$
\frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto - \frac{1}{2\sigma^{2}}\sum_{n=1}^{N} \left( 2 \left( x_n - \mu\right) \left(-1 \right) \right) - \frac{1}{2\tau_{0}^{2}}2 \left (\mu-\mu_{0}\right) 
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto \frac{1}{\sigma^{2}}\sum_{n=1}^{N}  \left( x_n - \mu\right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right)
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{1}{\sigma^{2}} \left( \sum_{n=1}^{N}x_n  - \sum_{n=1}^{N}  \mu \right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right)
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{1}{\sigma^{2}}  \left( \sum_{n=1}^{N}x_n  - \mu \sum_{n=1}^{N}  1 \right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right)
$$

Let $\bar{x}$ be the mean, then
$$
\bar{x} = \frac{\sum_{n=1}^{N} x_n}{N}
$$ 
$$
\implies \sum_{n=1}^{N} x_n  = N\bar{x}
$$ 

And  $\sum_{n=1}^{N} 1 = N$

On substituting the above values in  $\frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right)$ we get,
$$
\frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{1}{\sigma^{2}}  \left( N\bar{x}  - \mu N\right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right)
$$
$$
\implies \frac{d}{d\mu} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{N}{\sigma^{2}}  \left( \bar{x}  - \mu \right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right)
$$
Taking second derivative,
$$
 \frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{d}{d\mu} \left( \frac{N}{\sigma^{2}}  \left( \bar{x}  - \mu \right) - \frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right) \right)
$$
$$
\implies \frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{d}{d\mu} \left( \frac{N}{\sigma^{2}}  \left( \bar{x}  - \mu \right) \right) - \frac{d}{d\mu}\left(\frac{1}{\tau_{0}^{2}}\left (\mu-\mu_{0}\right) \right)
$$
$$
\implies \frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto  \frac{d}{d\mu} \left( \frac{N}{\sigma^{2}} \bar{x}\right)  - \frac{d}{d\mu} \left(\frac{N}{\sigma^{2}}\mu \right) - \frac{d}{d\mu}\left(\frac{1}{\tau_{0}^{2}}\mu\right) + \frac{d}{d\mu}\left(\frac{1}{\tau_{0}^{2}}\mu_{0}\right) 
$$
$$
\implies \frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto   -  \left(\frac{N}{\sigma^{2}} \right) - \left(\frac{1}{\tau_{0}^{2}}\right) 
$$
$$
\implies \frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) \propto   -  \left(\frac{N}{\sigma^{2}} + \frac{1}{\tau_{0}^{2}}\right) 
$$
...
What do you think?  
Calculating the second derivative at mode yields a value less than zero, so, the mode does in fact correspond to the $\mu$ value associated with the maximum log-posterior density and not the minimum log-posterior density
...
$$
   \mu_{MAP} = \frac{\frac{1}{\tau_{0}^2}}{\frac{1}{\tau_{0}^2}+\frac{N}{\sigma^{2}}}\mu_{0} + \frac{\frac{N}{\sigma^2}}{\frac{1}{\tau_{0}^2}+\frac{N}{\sigma^{2}}}\bar{x}
$$
$$
   \mathrm{m}_N = \frac{\frac{1}{\tau_{0}^2}}{\frac{1}{\tau_{0}^2}+\frac{N}{\sigma^{2}}}\mu_{0} + \frac{\frac{N}{\sigma^2}}{\frac{1}{\tau_{0}^2}+\frac{N}{\sigma^{2}}}\bar{x}
$$

Also,
    Posterior precision is given as $-\frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x},\sigma\right) \right) |\mu=\mu_{MAP})$ 
    
$$
\frac{1}{\tau_{N}^2}  = -\frac{d^2}{d\mu^2} \log \left( p\left(\mu \mid \mathbf{x}, \sigma\right) \right) 
$$
$$
\implies \frac{1}{\tau_{N}^2} = \frac{1}{\tau_{0}^2} + \frac{N}{\sigma^2}
$$
### 2d)
...
The Laplace Approximation is a method used to approximate the posterior distribution of a model with a Gaussian distribution. In general, this approximation is only an approximation and becomes more accurate as the posterior becomes more Gaussian-like. However, for a one-parameter normal-normal model with an unknown mean, the Laplace Approximation is exact. This is because the posterior distribution in this case is actually Gaussian, making the Laplace Approximation unnecessary.

To see why this is the case, let's consider the normal-normal model with an unknown mean. In this model, we have observed data, x, which are normally distributed with a known variance, $\sigma$, but an unknown mean, $\mu$. We also assume a prior distribution for $\mu$, which is also normally distributed with mean $\mu_0$ and variance $\tau_0$.

The posterior distribution for μ, given the observed data, can be derived using Bayes' theorem:
$p(\mu\mid\mathbf{x}) \propto p(\mathbf{x}\mid\mu) * p(\mu)$
In this case, both the likelihood and the prior are normal distributions, so the posterior is also a normal distribution. Therefore, the Laplace Approximation is unnecessary in this case, and the posterior distribution can be calculated exactly using standard methods for Gaussian distributions.
...
What do you think?  
It it useful to transform $\sigma$ to $\varphi$ using a transformation like the natural log when we perform the inference with the Laplace Approximation as it removes higher orders which can make the optimization problem easier to solve. In particular, when optimizing the Laplace Approximation, we need to find the mode of the log-posterior, which involves taking the derivative of the log-posterior with respect to the parameters and setting it equal to zero. If we use the transformed parameter $\varphi$ instead of the original parameter $\sigma$, the derivative with respect to $\varphi$ can be easier to compute and manipulate than the derivative with respect to $\sigma$. Also, unlike $\sigma$, $\varphi$ is allowed to be unbounded. Laplace Approximation assumes the parameters to be unbounded, to remove the constraint, $\sigma > 0$, natural log is used.
...
Change of variables for a probability distribution is given as,
$$
p_{\varphi} \left(\mu ,\varphi \mid \mathbf{x} \right)  =  p_{\sigma} \left(\mu ,  g^{-1} \left(\varphi \right) \mid \mathbf{x} \right)  \left| \frac{d}{d\varphi} \left( g^{-1}\left(\varphi\right) \right) \right| 
$$
Given distribution, in terms of $\sigma$
$$
p \left( \mu,\sigma \mid \mathbf{x} \right) \propto \prod_{n=1}^{N} \left( \mathrm{normal} \left(x_n \mid \mu, \sigma \right) \times \mathrm{normal}\left(\mu \mid \mu_0, \tau_0\right) \times \mathrm{Exp}\left(\sigma \mid \lambda=0.5\right) \right) 
$$
Applying change of variables, we get

$$
p_{\varphi} \left(\mu, \varphi\mid \mathbf{x} \right)  \propto \left(  \prod_{n=1}^{N} \left( \mathrm{normal} \left(x_n \mid \mu, g^{-1}\left(\varphi\right) \right) \right) \times \mathrm{normal}\left(\mu \mid \mu_0, \tau_0\right) \times \mathrm{Exp}\left(g^{-1}\left(\varphi\right) \mid \lambda=0.5\right) \right) \left| \frac{d}{d\varphi} \left( g^{-1}\left(\varphi\right) \right) \right| 
$$
### 3c)
...
$$
\log\left| \frac{d}{d\varphi} \left( g^{-1}\left(\varphi\right) \right) \right| = \log \left( \frac{d}{d\varphi}  \exp \left( \varphi \right)  \right)
$$
$$
\implies \log\left| \frac{d}{d\varphi} \left( g^{-1}\left(\varphi\right) \right) \right| = \log \left( \exp \left( \varphi \right) \right)
$$
$$
\implies \log\left| \frac{d}{d\varphi} \left( g^{-1}\left(\varphi\right) \right) \right| =\varphi
$$
### 3d)
...
cv_param_grid %>% 
  ...
  geom_point(data = tibble::tibble(xbar = x_bar, log_xsd = log(sdx)),
...
Yes, the identified optimal parameter values the same for both optimizations
```{r}
...
```
The log-posterior surface of a statistical model is independent of the initial guesses for the parameters of the model. The initial parameter values are relevant in the context of optimization algorithms used to find the maximum a posteriori (MAP) as they start with an initial guess for the parameter values and then iteratively update the parameter values. Different initial guesses can lead to different estimates of the parameters, and the optimization algorithm can get stuck in a local optimum rather than finding the global optimum. However, the log-posterior surface itself is independent of the optimization algorithm and the initial parameter values, giving hint that there is a MAP and points would converge towards it eventually irrespective of direction and gradient.  
...
laplace_result <-  my_laplace(init_guess_01, my_cv_logpost,  my_info = hw06_info)
...
```{r echo=TRUE}
posterior_mean_varphi = laplace_result$mode[2]
posterior_mean_varphi
```
```{r echo=TRUE}
posterior_sd_mu = sqrt(laplace_result$var_matrix[1])
posterior_sd_mu
```
```{r echo=TRUE}
posterior_sd_varphi = sqrt(laplace_result$var_matrix[4])
posterior_sd_varphi
```
$cov\left(\mathbf{x1},\mathbf{x2}\right) = cov\left(\mathbf{x2},\mathbf{x1}\right) = \rho\sigma1\sigma2\\$
$\implies \rho = \frac{cov\left(\mathbf{x1},\mathbf{x2}\right)}{\sigma1\sigma2}$
```{r echo=TRUE}
pho = laplace_result$var_matrix[2]/(posterior_sd_mu*posterior_sd_varphi)
pho
```
...
```{r echo=TRUE}
pnorm(hw06_df$x%>%mean, laplace_result$mode[1], sqrt(laplace_result$var_matrix[1]))
```
...
```{r echo=TRUE, solution_05c, eval=TRUE}
set.seed(202004)
N = 1e4 
post_samples <-  generate_post_samples(laplace_result, N)
summary(post_samples)
```

Include as many code chunks and discussion text as you feel are necessary.  
```{r echo=TRUE}
exp(post_samples$varphi%>%mean) == post_samples$sigma%>%mean
```
...
```{r}
tibble_g4 <- post_samples %>% 
  count(sigma>4)
tibble_g4$n[2]/N
```
There is 10.8% chance that the noise is greater than 4 units.
